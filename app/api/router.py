...
from app.api.v1.endpoints import chat_router as chat_router_v1, notice_router, discordnews_router, presigned_router
...
# 위키 뉴스 이미지 presigned url API 등록 → /api/v1/presigned
api_router.include_router(presigned_router.router, prefix="/api/v1", tags=["presignedurl"])
